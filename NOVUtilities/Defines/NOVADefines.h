...
#ifndef NCommonDefines_h
#define NCommonDefines_h
...
/// 设备类型
#define IS_IPAD [NOVAHelper isIPad]
#define IS_IPOD [NOVAHelper isIPod]
#define IS_IPHONE [NOVAHelper isIPhone]
#define IS_SIMULATOR [NOVAHelper isSimulator]

/// 操作系统版本号，只获取第二级的版本号，例如 10.3.1 只会得到 10.3
#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] doubleValue])

/// 数字形式的操作系统版本号，可直接用于大小比较；如 110205 代表 11.2.5 版本；根据 iOS 规范，版本号最多可能有3位
#define IOS_VERSION_NUMBER [NOVAHelper numbericOSVersion]
...
#define APPLICATION_WIDTH [NOVAHelper applicationSize].width

/// 在 iPad 分屏模式下等于 app 实际运行宽度，否则等同于 DEVICE_HEIGHT
#define APPLICATION_HEIGHT [NOVAHelper applicationSize].height

/// 是否全面屏设备
#define IS_NOTCHED_SCREEN [NOVAHelper isNotchedScreen]
/// iPhone XS Max
#define IS_65INCH_SCREEN [NOVAHelper is65InchScreen]
/// iPhone XR
#define IS_61INCH_SCREEN [NOVAHelper is61InchScreen]
/// iPhone X/XS
#define IS_58INCH_SCREEN [NOVAHelper is58InchScreen]
/// iPhone 6/7/8 Plus
#define IS_55INCH_SCREEN [NOVAHelper is55InchScreen]
/// iPhone 6/7/8
#define IS_47INCH_SCREEN [NOVAHelper is47InchScreen]
/// iPhone 5/5S/SE
#define IS_40INCH_SCREEN [NOVAHelper is40InchScreen]
/// iPhone 4/4S
#define IS_35INCH_SCREEN [NOVAHelper is35InchScreen]
/// iPhone 4/4S/5/5S/SE
...
#define IS_ZOOMEDMODE [NOVAHelper isZoomedMode]

#pragma mark - 变量-布局相关

/// 获取一个像素
#define PixelOne [NOVAHelper pixelOne]
...
#define SafeAreaInsetsConstantForDeviceWithNotch [NOVAHelper safeAreaInsetsForDeviceWithNotch]
...
#define PreferredValueForNotchedDevice(_notchedDevice, _otherDevice) ([NOVAHelper isNotchedScreen] ? _notchedDevice : _otherDevice)

/// 将所有屏幕按照宽松/紧凑分类，其中 iPad、iPhone XS Max/XR/Plus 均为宽松屏幕，但开启了放大模式的设备均会视为紧凑屏幕
#define PreferredValueForVisualDevice(_regular, _compact) ([NOVAHelper isRegularScreen] ? _regular : _compact)
...
#define IPAD_SIMILAR_SCREEN_WIDTH [NOVAHelper preferredLayoutAsSimilarScreenWidthForIPad]

#define _40INCH_WIDTH [NOVAHelper screenSizeFor40Inch].width
#define _58INCH_WIDTH [NOVAHelper screenSizeFor58Inch].width
#define _65INCH_WIDTH [NOVAHelper screenSizeFor65Inch].width
