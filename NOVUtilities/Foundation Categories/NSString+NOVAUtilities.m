...
@implementation NSString (NOVAUtilities)
...
- (NSArray<NSValue *> *)allRangeOfString:(NSString *)string {
    NSRange searchRange = NSMakeRange(0,self.length);
    NSRange foundRange;
    NSMutableArray *array = [NSMutableArray array];
    while (searchRange.location < self.length) {
        searchRange.length = self.length-searchRange.location;
        foundRange = [self rangeOfString:string options:NSCaseInsensitiveSearch range:searchRange];
